  ...
  return (
    <div className="flex flex-col rounded-md bg-[#ecf7d4] overflow-hidden p-3 relative">
      <a href="#" className="relative h-32">
        ...
        <div className="absolute top-1 right-2 bg-white rounded-full p-1 cursor-pointer gap-1 flex items-center text-sm">
          <Heart size={16} className="hover:fill-red-500 hover:text-red-500" />
        </div>
      </a>
      <div className="flex mt-1">
        <p className="font-bold tracking-wide">Rosted Chicken</p>
      </div>
      <p className="my-2">Turkish kitchen</p>
      <div className="flex gap-2 mt-auto">
        <div className="flex gap-1 bg-[#d6f497] item-center p-1 rounded-md">
          <HeartPulse size={16} />
